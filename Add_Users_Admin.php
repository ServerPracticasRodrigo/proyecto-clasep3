        ...
        <form class="formularios" action="registros_users_admin.php" method="post">
            <h1>Alta de Usuarios</h1>
                    ...
                    <label class="text23">Nombre</label><br>
                        <input class="validacion" id="usuario" name="usuario" minlength="3" maxlength="15" required spellcheck="true" type="text" size="30" placeholder="Usuario" >
                    <br><br>                        
                    <label class="text23">Correo Electronico</label><br>
                        <input class="validacion" id="correo" name="correo" minlength="8" maxlength="25" required spellcheck="true" type="email" size="30" placeholder="Email">
                    <br><br>
