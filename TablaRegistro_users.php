...
<div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Tabla Control de Usuarios</h2>
                        <a href="Add_Users_Admin.php" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Agregar Nuevo Registro</a>
    ...
    {//bloque del if//
        ...
        echo '<a class=link href="borrar_usuario.php?id='. $row['idusuario'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
